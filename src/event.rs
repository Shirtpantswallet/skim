...
pub fn parse_event(action: &str, arg: Option<String>) -> Option<Event> {
    match action {
        ...
        "autocomplete-begin"    =>   Some(Event::EvActAutocompleteBegin),
        "autocomplete-next"     =>   Some(Event::EvActAutocompleteNext),
        "autocomplete-previous" =>   Some(Event::EvActAutocompletePrevious),
        "autocomplete-select"   =>   Some(Event::EvActAutocompleteSelect),
